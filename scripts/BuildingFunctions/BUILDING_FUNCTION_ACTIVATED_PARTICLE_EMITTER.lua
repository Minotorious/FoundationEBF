...
| ||  \\//  ||  //\/  |                         ----                         | |
| ||   \/   ||  V_/_  |              ACTIVATED PARTICLE EMITTER              | |
| ||        ||        |‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗/ |
\---------------------------------------------------------------------------]]--
...
local BUILDING_FUNCTION_ACTIVATED_PARTICLE_EMITTER = {
    TypeName = "BUILDING_FUNCTION_ACTIVATED_PARTICLE_EMITTER",
...
EBF:registerClass(BUILDING_FUNCTION_ACTIVATED_PARTICLE_EMITTER)

--[[---------------------------- CUSTOM COMPONENTS ----------------------------]]--

local COMP_ACTIVATED_PARTICLE_EMITTER = {
    TypeName = "COMP_ACTIVATED_PARTICLE_EMITTER",
...
function COMP_ACTIVATED_PARTICLE_EMITTER:create()
...
function COMP_ACTIVATED_PARTICLE_EMITTER:addToEmitterCompList(entry)
    table.insert(self.emitterCompList, entry)
end

function COMP_ACTIVATED_PARTICLE_EMITTER:setTriggeredParticleEmitterData(buildingFunctionData)
...
function COMP_ACTIVATED_PARTICLE_EMITTER:update()
...
EBF:registerClass(COMP_ACTIVATED_PARTICLE_EMITTER)
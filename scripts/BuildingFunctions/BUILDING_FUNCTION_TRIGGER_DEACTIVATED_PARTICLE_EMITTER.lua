...
| ||  \\//  ||  //\/  |                         ----                         | |
| ||   \/   ||  V_/_  |              TRIGGERED PARTICLE EMITTER              | |
| ||        ||        |‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗‗/ |
\---------------------------------------------------------------------------]]--
...
local BUILDING_FUNCTION_TRIGGER_DEACTIVATED_PARTICLE_EMITTER = {
    TypeName = "BUILDING_FUNCTION_TRIGGER_DEACTIVATED_PARTICLE_EMITTER",
...
function BUILDING_FUNCTION_TRIGGER_DEACTIVATED_PARTICLE_EMITTER:activateBuilding(gameObject)
    --EBF:log("Building Function Activate Building")
    comp = gameObject:getOrCreateComponent("COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER")
    comp:setTriggeredParticleEmitterData(self)
    
    return true
end

function BUILDING_FUNCTION_TRIGGER_DEACTIVATED_PARTICLE_EMITTER:reloadBuildingFunction(gameObject)
    --EBF:log("Building Function Reload")
    comp = gameObject:getOrCreateComponent("COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER")
    comp:setTriggeredParticleEmitterData(self)
end

EBF:registerClass(BUILDING_FUNCTION_TRIGGER_DEACTIVATED_PARTICLE_EMITTER)

--[[---------------------------- CUSTOM COMPONENTS ----------------------------]]--

local COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER = {
    TypeName = "COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER",
...
function COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER:create()
...
function COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER:addToEmitterCompList(entry)
    table.insert(self.emitterCompList, entry)
end

function COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER:setTriggeredParticleEmitterData(buildingFunctionData)
...
function COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER:update()
...
EBF:registerClass(COMP_TRIGGER_DEACTIVATED_PARTICLE_EMITTER)